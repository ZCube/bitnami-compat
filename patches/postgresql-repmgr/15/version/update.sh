...
export VERSION_MAJOR=${VERSION_MAJOR:-15}
...
cat ${VERSION_DIR}.bitnami_components.json | jq -M --arg VERSION_ORIGINAL "$VERSION_ORIGINAL" '."postgresql-repmgr".version = $VERSION_ORIGINAL' > /tmp/components.json
